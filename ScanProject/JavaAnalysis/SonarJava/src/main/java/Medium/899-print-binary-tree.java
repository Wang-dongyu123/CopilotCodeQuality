package main.java.Medium; /**https://leetcode.com/problems/print-binary-tree/ */
...
class Solution545 {
    public List<List<String>> printTree(TreeNode110 root) {
    ...
    private void helper(TreeNode110 root, List<List<String>> result, int row, int left, int right) {
        if (root == null) {
            return;
        }
    ...
    private int getHeight(TreeNode110 root) {
        if (root == null) {
            return 0;
        }
