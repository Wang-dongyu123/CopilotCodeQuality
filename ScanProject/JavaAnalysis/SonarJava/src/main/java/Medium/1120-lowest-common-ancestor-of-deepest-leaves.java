package main.java.Medium; /**https://leetcode.com/problems/lowest-common-ancestor-of-deepest-leaves/ */
...
class TreeNode63 {
      ...
      TreeNode63 right;
      TreeNode63() {}
      TreeNode63(int val) { this.val = val; }
      TreeNode63(int val, TreeNode63 left, TreeNode63 right) {
          this.val = val;
          this.left = left;
          this.right = right;
      }
...
class Solution29 {
    public TreeNode63 lcaDeepestLeaves(TreeNode63 root) {
    ...
    private int depth(TreeNode63 root) {
        if(root == null) {
            return 0;
        }
